...
## News
**\[2024/11\]** TorchSparse++ has been integerated to [MMDetection3D](https://github.com/open-mmlab/mmdetection3d) and [OpenPCDet](https://github.com/open-mmlab/OpenPCDet) in a plugin style! [A full demo](./examples/) is available.
